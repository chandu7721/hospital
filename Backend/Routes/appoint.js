...
Router.post("/a_Insert", (req, res) => {
  let Details = req.body;
  console.log(Details);
  Result("appoint", "a_Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:ID", (req, res) => {
  ...
  console.log(Details);
  Result("appoint", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
